...
PATH="$HOME/opt/idea-IC-182.5107.16:$HOME/.local/bin:$HOME/.cabal/bin:$PATH:$HOME/tor-browser/tor-browser_en-US/Browser"
export DXMMS2_FONT_WIDTH=10
export DMENU_FONT="Noto Sans Mono CJK JP"
...
export CDRIP_RHOST=server.home
